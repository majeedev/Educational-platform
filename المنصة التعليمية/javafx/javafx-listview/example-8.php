...
<!-- Mirrored from harmash.com/javafx/javafx-listview/example-8.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Jun 2020 20:34:21 GMT -->
...
<head>
    ...
    <title>JavaFX - طريقة جعل المستخدم قادر على تعديل نص عناصر ال ListView</title>
...
<li><a href="../javafx-company-products-manager-source-code/index.html"><span class="en">JavaFX</span> - برنامج إدارة المحتوى</a></li>
            ...
            <div id="main">
                ...
                <h1><span class="session">JavaFX</span>طريقة جعل المستخدم قادر على تعديل نص عناصر <span class="inline">الـ<code data-enlighter-language="java">ListView</code></span></h1>
<article>
	<p>المثال التالي يعلمك طريقة جعل المستخدم قادر على تعديل نص عناصر <span class="inline">الـ <code data-enlighter-language="java">ListView</code>.</span></p>
	<br>
...
public class Main extends Application {
    ...
    public static void main(String[] args) {
		...
		<p><span class="point">•</span>ستظهر لك النافذة التالية عند التشغيل و التي يمكنك إختيار عنصر واحد منها في كل مرة.</p>
		<div class="image-box">
    	    <a target="_blank" href="example-8.gif"><img src="example-8.gif" alt=" طريقة جعل المستخدم قادر على تعديل نص عناصر ال ListView في javafx"/></a>
    	</div>
	</div>
</article>
...
<!-- Mirrored from harmash.com/javafx/javafx-listview/example-8.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Jun 2020 20:34:22 GMT -->
</html>