...
<!-- Mirrored from harmash.com/java/java-data-structure/enumeration.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Jun 2020 17:01:16 GMT -->
...
<head>
    ...
    <title>الإنترفيس Enumeration في جافا</title>
...
<!--<p class="center red b" style="padding-top: 20px; font-size: 14px;">لا زلنا نعمل على إعداد دروس جديدة</p>-->
            ...
            <div id="main">
                ...
                <h1><span class="session">Java</span>الإنترفيس <code data-enlighter-language="java">Enumeration</code> في جافا</h1>
<article>
    <h2>مقدمة</h2>
	<p>الـ <code data-enlighter-language="java">Enumeration</code> هو إنترفيس يستخدم لتخزين عناصر متتالية موجودة  في <span class="word">Data Structure</span> معينة دفعة واحدة.<br>
	بعدها يمكنه إرجاع هذه العناصر واحداً تلو الآخر بواسطة الدالة <code data-enlighter-language="java">nextElement()</code>.</p>
	<p>فعلياً لا يعتبر <span class="word">Data Structure</span> معينة بحد ذاته, لكن بعض الكلاسات و الإنترفيسات الأخرى التي تنتمي لفئة الـ <span class="word">Data Structure</span> تعتمد عليه,  مثل الكلاسات <code data-enlighter-language="java">Vector</code> و <code data-enlighter-language="java">Properties</code>.</p>
	<p>في الدرس التالي سنتعرف على إنترفيس يشبهه إسمه <code data-enlighter-language="java">Iterator</code>.</p>
</article>
<article>
    <h2>دوال الإنترفيس <code data-enlighter-language="java">Enumeration</code></h2>
	<p>الجدول التالي يحتوي على دوال الإنترفيس <span class="word">Enumeration</span>.</p>
	<table class="list full-width rows-numbers">
	    <tr>
			<th colspan="2">الدالة مع تعريفها</th>
		</tr>
		    <td><span class="code-title"><code data-enlighter-language="java">public boolean hasMoreElements()</code></span>
			ترجع <code data-enlighter-language="java">true</code> في حال كان كائن الـ <code data-enlighter-language="java">Enumeration</code> لا يزال يحتوي على عناصر.</td>
		</tr>
	    <tr>
		    <td><span class="code-title"><code data-enlighter-language="java">public Object nextElement()</code></span>
			ترجع العنصر التالي الموجود في كائن الـ <code data-enlighter-language="java">Enumeration</code>, ترجعه كـ <code data-enlighter-language="java">Object</code>.</td>
		</tr>
	</table>
</article>
<article>
