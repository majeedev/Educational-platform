...
<!-- Mirrored from harmash.com/python/python-date-and-time/datetime-strftime-m.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Jun 2020 20:33:59 GMT -->
...
<head>
    ...
    <title>python datetime.strftime('%m')</title>
...
<li><a href="index.html"><span class="en">Python</span> - التاريخ و الوقت</a></li>
...
<li><a href="../../algorithms-and-data-structure/index.html"><span class="en">Python</span> - الخوارزميات و هياكل البيانات</a></li>
            ...
            <div id="main">
                ...
                <h1><span class="session">Python</span> <code data-enlighter-language="python">datetime.strftime('%m')</code></h1>
<article>
	<p>في المثال التالي سنمرر الرمز <code data-enlighter-language="python">%m</code> كنص للدالة <code data-enlighter-language="python">strftime()</code> لإظهار رقم الشهر بالنسبة للسنة, مع الأخذ بالإعتبار أن هذا الرقم سيكون ضمن النطاق <code data-enlighter-language="python">01 - 12</code></p>
