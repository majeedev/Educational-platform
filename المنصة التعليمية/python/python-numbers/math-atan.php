...
<!-- Mirrored from harmash.com/python/python-numbers/math-atan.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Jun 2020 20:33:59 GMT -->
...
<li><a href="index.html"><span class="en">Python</span> - الأرقام</a></li>
...
<li><a href="../../algorithms-and-data-structure/index.html"><span class="en">Python</span> - الخوارزميات و هياكل البيانات</a></li>
            ...
            <div id="main">
                ...
                <h1><span class="session">Python</span>الدالة <code data-enlighter-language="python">atan()</code></h1>
<article>
    <h3>تعريفها</h3>
	<p>ترجع قيمة الـ <span class="word">arc tangent</span> للعدد الذي نمرره لها مكان الباراميتر <code data-enlighter-language="python">x</code>.</p>
	<br>
	<h3>بناؤها</h3>
...
atan(x)
	...
	<br>
	<h3>باراميترات</h3>
	<p><code data-enlighter-language="python">x</code> عبارة عن عدد ليس له نوع محدد.</p>
	<br>
	<h3>قيمة الإرجاع</h3>
	<p>ترجع قيمة الـ <span class="word">arc tangent</span> للعدد الذي نمرره لها مكان الباراميتر <code data-enlighter-language="python">x</code>, ترجعه كـ <code data-enlighter-language="python">float</code>.</p>
	<br>
