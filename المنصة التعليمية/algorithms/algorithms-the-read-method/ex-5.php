...
<!-- Mirrored from harmash.com/algorithms/algorithms-the-read-method/ex-5.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Jun 2020 16:18:30 GMT -->
...
<head>
    ...
    <title>دالة إدخال البيانات Read في الخوارزميات - التمرين الخامس</title>
...
<li><a href="index.html">دالة الإدخال <span class="en">Read</span></a></li>
...
<li><a href="../algorithms-parameters/index.html">التعامل مع الباراميترات</a></li>
...
<li><a href="../algorithms-write-less-code/index.html">تقليص حجم الكود</a></li>
            ...
            <div id="main">
                ...
                <h1><span class="session">Algorithms</span>دالة إدخال البيانات <code data-enlighter-language="java">Read</code> في الخوارزميات - التمرين الخامس</h1>
<article>
	<h3>المطلوب</h3>
	<p>أكتب برنامج يطلب من المستخدم إعطائه عددين صحيحين, ثم يقارن العددين اللذين قام المستخدم بإدخالهما ثم يخبره نتيجة المقارنة.</p>
	<br>
	<h3>إرشادات</h3>
	<p>العدد الأول سنخزنه في المتغير <code data-enlighter-language="java">a</code>.<br>
	العدد الثاني سنخزنه في المتغير <code data-enlighter-language="java">b</code>.</p>
	<br>
	<div class="example-box">
	    <h4>النتيجة المطلوبة</h4>
		<p>لنفترض أن المستخدم أدخل العددين: <span class="number">4</span> و <span class="number">9</span>.</p>
	    <div class="image-box">
		    <a target="_blank" href="ex-5-pic-1.png"><img src="ex-5-pic-1.png" alt=""/></a>
		</div>
		<p>لنفترض أن المستخدم أدخل العددين: <span class="number">8</span> و <span class="number">2</span>.</p>
	    <div class="image-box">
		    <a target="_blank" href="ex-5-pic-2.png"><img src="ex-5-pic-2.png" alt=""/></a>
		</div>
		<p>لنفترض أن المستخدم أدخل العددين: <span class="number">5</span> و <span class="number">5</span>.</p>
	    <div class="image-box">
	...
	<div class="example-box">
	    <h4>الخوارزمية</h4>
	    <div class="image-box">
		    <a target="_blank" href="ex-5-pic-5.png"><img src="ex-5-pic-5.png" alt=""/></a>
		</div>
	</div>
	<div class="example-box">
	    <h4>كود الجافا</h4>
...
public class Compare_Two_Numbers {
	...
	<div class="example-box">
	    ...
	    <div class="explaining-box">
		    <ul>
				<br>
				<pre data-enlighter-language="java" data-enlighter-lineoffset="9">
		int a;
		int b;
				</pre>
				<li><p>قمنا بتجهيز المتغيرات <code data-enlighter-language="java">a</code> و <code data-enlighter-language="java">b</code> لتخزين الأعداد التي سيدخلها المستخدم عند تشغيل البرنامج.</p></li>				
				<br><br>
				<pre data-enlighter-language="java" data-enlighter-lineoffset="12">
		System.out.print("Enter first number : ");
		a = input.nextInt();
		...
		b = input.nextInt();
			    ...
			    <li><p>هنا طلبنا من المستخدم إدخال عددين, و خزّنا العددين في المتغيرات <code data-enlighter-language="java">a</code> و <code data-enlighter-language="java">b</code>.</p></li>
				<br><br>
				<pre data-enlighter-language="java" data-enlighter-lineoffset="18">
		if ( a > b )
		{
			System.out.print(a+ " > " +b+ "\n" );
		}
		...
		else
		{
			System.out.print(a+ " = " +b+ "\n" );
				...
				<li><p>بعد إدخال العددين, سيقوم البرنامج بمقارنة العددين كالتالي:</p></li>
				<ul type="square">
					<li><p>إذا كانت قيمة <code data-enlighter-language="java">a</code> أكبر من قيمة <code data-enlighter-language="java">b</code> سينفذ أمر الطباعة الموجود في الشرط الأول.</p></li>
					<li><p>إذا كانت قيمة <code data-enlighter-language="java">a</code> أصغر من قيمة <code data-enlighter-language="java">b</code> سينفذ أمر الطباعة الموجود في الشرط الثاني.</p></li>
					<li><p>إذا كانت قيمة <code data-enlighter-language="java">a</code> تساوي قيمة <code data-enlighter-language="java">b</code> سينفذ أمر الطباعة الموجود في الشرط الثالث.</p></li>
				</ul>
			</ul>
		</div>
	</div>
...
<!-- Mirrored from harmash.com/algorithms/algorithms-the-read-method/ex-5.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Jun 2020 16:18:33 GMT -->
</html>