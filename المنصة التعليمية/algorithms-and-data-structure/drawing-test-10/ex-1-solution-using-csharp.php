...
<!-- Mirrored from harmash.com/algorithms-and-data-structure/drawing-test-10/ex-1-solution-using-csharp.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Jun 2020 20:33:44 GMT -->
...
<head>
    ...
    <title>تمارين خوارزميات و هياكل البيانات - التحدي العاشر - حل التمرين الأول بلغة C#</title>
...
<li><a href="index.html">التحدي العاشر</a></li>
...
<li><a href="../useful-resources/index.html">مصادر مفيدة</a></li>
            ...
            <div id="main">
                ...
                <h1><span class="session">Algorithms & Data Structure</span>التحدي العاشر - حل التمرين الأول بلغة <span class="word">C#</span></h1>
<article>
    <h3>المطلوب</h3>
	<p>أكتب برنامج مهمته رسم الشكل التالي بواسطة الحلقات.<br>
	عند تشغيل البرنامج, يجب أن يطلب من المستخدم إدخال عدد بين <span class="number">1</span> و <span class="number">9</span> حتى يتم رسم الشكل المطلوب بناءاً عليه.</p>
	<p><a target="_blank" href="ex-1.png"><img src="ex-1.png"></a></p>
	<br>
